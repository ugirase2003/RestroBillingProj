...
public class Beverages extends Fragment {
    ...
    ArrayList<Menu_Model> Beverages_Item_List=new ArrayList<>();
    Menu_Ad ad;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_beverages, container, false);
       recyclerView=v.findViewById(R.id.beveragesRecycler);


        getBeverageItems();
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        ad=new Menu_Ad(getActivity(),Beverages_Item_List);
                ...
                for(DocumentChange dc:value.getDocumentChanges()){
                    if(dc.getType()==DocumentChange.Type.ADDED){
                        try {
                            ...
                            if(data.getItem_category().equals("Beverages")){

                                Beverages_Item_List.add(data);
                            }
