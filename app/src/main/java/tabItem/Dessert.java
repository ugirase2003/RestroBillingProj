...
public class Dessert extends Fragment {
    ...
    ArrayList<Menu_Model> _Item_List=new ArrayList<>();
    ArrayList<Menu_Model> Dessert_Item_List=new ArrayList<>();
    Menu_Ad ad;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=v.findViewById(R.id.dessertRecycler);

        getDessertItems();
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        ad=new Menu_Ad(getActivity(),Dessert_Item_List);
                ...
                for(DocumentChange dc:value.getDocumentChanges()){
                    if(dc.getType()==DocumentChange.Type.ADDED){
                        try {
                            ...
                            if(data.getItem_category().equals("Dessert")){

                                Dessert_Item_List.add(data);
                            }
